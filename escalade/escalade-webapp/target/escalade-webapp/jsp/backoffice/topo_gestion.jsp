	        ...
	        <th>Supprimer</th>
   		  ...
   		  <s:iterator value="listTopos">
		      <tr>
		        ...
		        <td><s:a action="detail_topo"><s:param name="id" value="id" /><button class="btn btn-warning">modifier</button></s:a></td>
		        <td><s:a action="delete_topo"><s:param name="id" value="id" /><button class="btn btn-danger">supprimer</button></s:a></td>
		      </tr>
		    </s:iterator>
		   </tbody>
