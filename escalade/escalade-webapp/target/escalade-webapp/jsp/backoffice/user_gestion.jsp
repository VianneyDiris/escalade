	        ...
	        <th>Supprimer</th>
   		  ...
   		  <s:iterator value="listUsers">
		      <tr>
		        ...
		        <td><s:a action="detail_user"><s:param name="id" value="id" /><button class="btn btn-warning">modifier</button></s:a></td>
		        <td><s:a action="delete_user"><s:param name="id" value="id" /><button class="btn btn-danger">supprimer</button></s:a></td>
		      </tr>
		    </s:iterator>
		   </tbody>
